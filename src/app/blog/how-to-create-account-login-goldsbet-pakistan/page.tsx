        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600">
              Complete step-by-step guide to create your <Link href="/" className="text-yellow-600 hover:text-yellow-700 font-semibold">GoldsBet</Link> account and login securely for Pakistani players.
            </p>
          </div>
